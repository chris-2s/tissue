...
from app.api import auth, user, setting, video, common, file, download, history, schedule, home, subscribe, site, actor
from app.dependencies.security import verify_auth

api_router = APIRouter()

api_router.include_router(auth.router, prefix="/auth")
api_router.include_router(common.router, prefix="/common")
api_router.include_router(user.router, prefix='/user', dependencies=[Depends(verify_auth)])
api_router.include_router(setting.router, prefix='/setting', dependencies=[Depends(verify_auth)])

api_router.include_router(video.router, prefix='/video', dependencies=[Depends(verify_auth)])
api_router.include_router(file.router, prefix='/file', dependencies=[Depends(verify_auth)])
